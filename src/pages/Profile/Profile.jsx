                    ...
                    <div className="modal-content">
                      ...
                      >
                        <div className="modal-body">
                          <input type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Name" defaultValue={profile.name} />
                          <input
                            type="file"
            ...
            {view === 'MyRecipe' ? (
                ...
                {ownProduct.map((data) => (
                  <div className="row ">
                    <div className="col-12 ">
                      <img className="me-3 rounded-4" style={{ width: '340px', height: '170px' }} src={data.image} alt="" />
                ...
                <div className="modal fade" id="edit" tabindex="-1" aria-labelledby="editLabel" aria-hidden="true">
                  <div className="modal-dialog">
                    <div className="modal-content">
                      ...
                      >
                        <div className="modal-body">
                          <input type="file" className="form-control " aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" placeholder="Change Photo" name="image" onChange={handleImageChange} />
                          ...
                          <input type="text" className="form-control mt-3" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="ingredients" value={detailProduct.ingredients} onChange={handleInputChange} />
                          ...
                          <input type="text" className="form-control mt-3" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="description" value={detailProduct.description} onChange={handleInputChange} />
                        </div>
                        <div className="modal-footer">
              ...
              <div className="d-flex">
                {savedProduct.map((data) => (
                  <div>
                    <img className="rounded-4" style={{ width: '340px', height: '170px' }} src={data.image} alt="" />
                    <span className={style.titleImage}>{data.name_recipe}</span>
                  </div>
                ))}
              </div>
